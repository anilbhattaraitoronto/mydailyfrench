export let posts = {
    ...
    blogs: [
        {
            postedOn: "December 15 2019 Sunday",
            title: "Bienvenue",
            imageLocation: " ",
            content: `
            ...
            <p>Bienvenue tout le monde au ma premère site d'internet française! C'est ma façon d'apprendre la nouvelle langue - par ècrire quelque chose touts les jours! Je pense que tout le monde peut apprendre quelconque langue! La seule chose que nous doivons faire, c'est que nous ecrivons, et nous lisons, et, finelmment, nous écoutons quelque chose regulierement!</p>
            `
        },
    ],
    //Fweets List
